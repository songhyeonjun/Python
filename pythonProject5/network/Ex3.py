...
def runThreadProgress():
    ...
    thBar4 = ThreadProgressBar(window)
    thBar5 = ThreadProgressBar(window)
    thBar6 = ThreadProgressBar(window)
...
if __name__ == '__main__':
    ...
    window.title("멀티 스레드")
    tButton = Button(window, text="멀티 스레드 시작", command=runThreadProgress)
    tButton.pack(side=TOP, fill=X, ipadx=10, ipady=10, padx=10, pady=10)
